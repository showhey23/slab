...
(function(){
  ...
  function onScroll(){
    ...
    try{localStorage.setItem('ccafa-scroll-'+dom.dataset.domain,window.scrollY);}catch(e){}
  }
  function activate(n,restore){
    ...
    try{localStorage.setItem('ccafa-domain',n);}catch(e){}
    var y=0;if(restore){try{y=+localStorage.getItem('ccafa-scroll-'+n)||0;}catch(e){}}
  ...
  var start=1;try{start=+localStorage.getItem('ccafa-domain')||1;}catch(e){}
